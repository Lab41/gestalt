...
INSERT INTO collection (name, url_name) VALUES
...
CREATE TABLE persona_collection_story ( 
    id SERIAL PRIMARY KEY,
    persona_id INTEGER,
    collection_id INTEGER,
    story_id INTEGER NOT NULL,
    UNIQUE (persona_id, collection_id, story_id)
);
 
INSERT INTO persona_collection_story (persona_id, collection_id, story_id) VALUES
    ('1', '1', '1');
INSERT INTO persona_collection_story (persona_id, collection_id, story_id) VALUES
    ('1', '1', '2');
INSERT INTO persona_collection_story (persona_id, collection_id, story_id) VALUES
...
SELECT DISTINCT pcs.collection_id, st.tag_id 
    FROM story_tag st
