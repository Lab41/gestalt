...
urls = (
    ...
    # 0.0.0.0:8000/api/panel/getSinglePanel/#
    #   where # == panel.id
    "getSinglePanel/(\d+)", "getSinglePanel",
    # 0.0.0.0:8000/api/story/getAllPanelsByWorkspace/#
    #   where # == workspace.id
    "getAllPanelsByWorkspace/(\d+)", "getAllPanelsByWorkspace",
    # 0.0.0.0:8000/api/panel/getDefaultPanelByWorkspace/#
    #   where # == workspace.id
...
class getDefaultPanelByWorkspace:
    ...
    assumption:
        * return one panel if data are inputted correctly
    input:
        * workspace.id
    output:
        * panel.id
